...
<body>
	<div class="easyui-layout" data-options="fit:true">
		...
		<div id="wu-toolbar-2">
			<div class="wu-toolbar-button">
				...
				<a href="javascript:;" class="easyui-linkbutton" iconCls="icon-print" onclick="exportt()" plain="true">导出</a>
			</div>
	...
	<script type="text/javascript">
		...
		function openEdit() {
			...
			$("#ubirthday").val(item.formateBirthday);
			$("#usex").val(item.sex);
			$("#utel").val(item.tel);
							...
							columns : [ [
									...
									
									{
										...
										formatter : function(value, rows, index) {
											...
											str += '<a href="javascript:void(0)" class="user-easyui-linkbutton-remove" data-options="plain:true,iconCls:\'icon-remove\'"  onclick="remove();">删除</a>';
											return str;
										}
									} ] ],
